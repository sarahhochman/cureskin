...
SEARCH_INPUT = (By.XPATH, '//div[@class="header__icons"]//search-modal[@class="header__search"]')
...
@when('Click Enter Search')
def click_enter_search(context):
    context.app.search_page.click_enter_search(SEARCH_INPUT)
